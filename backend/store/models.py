...
class ProductFaq(models.Model):
    ...
    class Meta:
        verbose_name_plural = "Produkt Fragen"
        ordering = ["-date"]
...
class CartOrderItem(models.Model):
    ...
    class Meta:
        verbose_name_plural = "Warenkorb Element"
        ordering = ["-date"]
...
class Wishlist(models.Model):
    ...
    class Meta:
        verbose_name_plural = "Wunschliste"
...
class CancelledOrder(models.Model):
    ...
    class Meta:
        verbose_name_plural = "Abgebrochene Bestellungen"
